...
object TermuxConstants {
    ...
    const val EXTRA_LABEL = "com.termux.RUN_COMMAND_LABEL"
    ...
    const val EXTRA_PLUGIN_RESULT_BUNDLE = "result_bundle"
    const val EXTRA_PLUGIN_RESULT_BUNDLE_ALT = "com.termux.RUN_COMMAND_RESULT_BUNDLE"
    ...
    const val RESULT_BUNDLE_ERR_CODE = "errCode"
